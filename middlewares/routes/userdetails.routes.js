  ...
  try {
    ...
    if (phone !== null) {
      if (phone.user_status == 'Incomplete') {
        ...
        const message = `Dear ${req.body.first_name+" "+req.body.last_name + 'SG'}, your login One Time Password is ${random}.-We Know How To Choose Fresh Fish`;;
...
////////// payment Process ////////////
  ...
  try{
    ...
    const message = `Dear ${req.body.first_name + 'Pv'}, your login One Time Password is ${random}.-We Know How To Choose Fresh Fish`;;
    global.send_sms(req.body.user_phone, message,"1607100000000220483").then(response=>{
    ...
    router.post('/mobile/login', async function (req, res) {
      ...
      if (userdetails == null) {
        ...
        const message = `Dear ${updatedetails.first_name + 'LG'}, your login One Time Password is ${random}.-We Know How To Choose Fresh Fish`;;
        global.send_sms(req.body.user_phone, message,"1607100000000220483").then(response=>{

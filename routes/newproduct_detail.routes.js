...
router.post('/mobile/get_favlist', async function (req, res) {
  ...
  let stock_params = {store:new mongoose.Types.ObjectId(req.body.store),fish_combo_id: new mongoose.Types.ObjectId(item.product_details_id.fish_combo_id), status: true, delete_status: false, soldout: false };
